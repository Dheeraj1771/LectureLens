...
prompt = f'''I am teaching web development in my Sigma web development Here are video subtitle chunks containing video title, video number, start time in seconds, 
